...
function buildSubAgentInput(taskMessage: VirtualMessage, parentSessionKey: string) {
  return [
    ...
    "Collaboration protocol: mail is the coordination primitive and the parent room is a shared discussion.",
    "Return concise facts, open questions, decisions, commitments, or draft text that the parent room pre can carry forward.",
    "If your findings conflict with another agent or artifact, preserve the conflict explicitly instead of silently choosing one claim.",
